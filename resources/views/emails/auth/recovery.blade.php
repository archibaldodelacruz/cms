...
@section('content')
    ...
    <table width="200" cellpadding="0" cellspacing="0" align="center" border="0">
        ...
        line-height:18px;">
                <a href="http://{{ $user->web->getDomainOrSubdomain() }}{{ route('auth::password', ['token' => $user->remember_token], false) }}" target="_blank" alias="" style="text-decoration: none; color: #ffffff;">Recuperar cuenta</a>
            </td>
        </tr>
    </table>
    <!-- End Button -->
