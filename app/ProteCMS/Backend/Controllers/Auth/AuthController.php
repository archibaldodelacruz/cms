...
namespace App\ProteCMS\Backend\Controllers\Auth;

use Auth;
use Mail;
use App\ProteCMS\Core\Models\Users\User;
use Illuminate\Http\Request;
use App\ProteCMS\Backend\Controllers\Controller;
...
class AuthController extends Controller
{
    ...
    public function login_post(LoginRequest $request)
    {
        ...
        if (! shelter()->users()->where('email', $request->get('email'))->exists()) {
